              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <a
                    key={info.title}
                    href={info.link}
                    className="flex items-center space-x-4 p-4 bg-slate-900/80 backdrop-blur-sm rounded-lg shadow-md hover:bg-slate-800/80 transition-all duration-200 transform hover:-translate-y-1 border border-slate-700/50"
                  >
